...
export function SearchWidget({
  ...
  return (
    <div className="flex w-full flex-col items-center gap-4">
      ...
      >
        <div className="relative flex flex-1 items-center gap-3 border-b border-border px-5 py-4 text-left sm:border-b-0 sm:border-r">
        ...
        <div className="flex flex-1 items-center gap-2 border-b border-border px-5 py-4 text-left sm:border-b-0 sm:border-r">
