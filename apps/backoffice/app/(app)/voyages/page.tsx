...
// Ex-page d'accueil ("/") — déplacée ici sans changement de contenu par le
// chantier de redesign de la nav ; "/" est désormais le Dashboard.
// /trajets/[id] et /trajets/nouveau ne changent pas d'emplacement.
